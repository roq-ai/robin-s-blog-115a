...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'picture.create': {
    roles: ['owner'],
    key: 'admin-uploaded-picture',
    tenantPath: ['organization', 'album', 'picture'],
    userPath: [],
  },
  'picture.delete': {
    roles: ['owner'],
    key: 'admin-deleted-picture',
    tenantPath: ['organization', 'album', 'picture'],
    userPath: [],
  },
  'archive.create': {
    roles: ['owner'],
    key: 'admin-archived-picture',
    tenantPath: ['organization', 'album', 'picture', 'archive'],
    userPath: [],
  },
};
