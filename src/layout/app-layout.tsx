...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Albums', path: '/albums', entity: 'album', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Archives', path: '/archives', entity: 'archive', service: AccessServiceEnum.PROJECT, icon: FiArchive },
    {
      name: 'Invitations',
      path: '/invitations',
      entity: 'invitation',
    ...
    { name: 'Pictures', path: '/pictures', entity: 'picture', service: AccessServiceEnum.PROJECT, icon: FiImage },
